package com.accenture.tcf.bars.darren.e.b.manuel.exception;
...
public class BarsException extends Exception {
    ...
    public static final String BILLING_CYCLE_NOT_ON_RANGE = "ERROR: Invalid Billing Cycle Range at row: ";
